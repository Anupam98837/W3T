{{-- resources/views/layouts/structure.blade.php
    W3Techiez Layout • Fixes:
    - Header actions stay at the far right even on very wide (24") screens
    - Role chip shows “Super Admin” (auto-reads from storage if present)
    - SweetAlert2 confirmation + success/error flows on logout
    - Clears session/local storage on logout
--}}
<!DOCTYPE html>
<html lang="en">
<head>
...
<aside id="sidebar" class="w3-sidebar" aria-label="Sidebar">
  ...
  <div class="w3-sidebar-scroll">
    ...
    <nav class="w3-menu" aria-label="Academics">
      <div class="w3-group">
        ...
        <div id="sm-courses" class="w3-submenu" role="group" aria-label="Courses submenu">
          <a href="/super_admin/courses/manage" class="w3-link">All Courses</a>
          <a href="/super_admin/courses/create" class="w3-link">Create Course</a>
      ...
      <div class="w3-group">
        ...
        <div id="sm-students" class="w3-submenu" role="group" aria-label="Students submenu">
          <a href="/super_admin/users/manage" class="w3-link">Manage Users</a>
          <a href="/super_admin/batches/manage" class="w3-link">Batches</a>
    ...
    <nav class="w3-menu" aria-label="Operations">
      ...
      <a href="/super_admin/mailers/manage" class="w3-link"><i class="fa-solid fa-gear"></i><span>Mailer</span></a>
    </nav>
    ...
    <div class="ms-auto d-flex align-items-center gap-2">
      ...
      <div class="dropdown d-none d-lg-block">
        <a href="#" class="btn btn-primary rounded-pill d-flex align-items-center gap-2 px-3" id="userMenu" data-bs-toggle="dropdown" aria-expanded="false">
          ...
          <span id="userRoleLabel" class="d-none d-xl-inline">Super Admin</span>
        </a>
