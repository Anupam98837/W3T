{{-- resources/views/pages/users/instructor/layout/structure.blade.php --}}
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8"/>
...
<aside id="sidebar" class="w3-sidebar" aria-label="Sidebar">
  <div class="w3-sidebar-head">
    <a href="/instructor/dashboard" class="w3-brand">
  ...
  <div class="w3-sidebar-scroll">
    ...
    <nav class="w3-menu" aria-label="Overview">
      <a href="/instructor/dashboard" class="w3-link"><i class="fa-solid fa-gauge"></i><span>Dashboard</span></a>
    </nav>
 
    <!-- Teaching -->
    <div class="w3-nav-section">
      <div class="w3-section-title"><i class="fa-solid fa-chalkboard-user"></i> TEACHING</div>
      <div class="w3-section-rule"></div>
    </div>
    <nav class="w3-menu" aria-label="Teaching">
      ...
      <div class="w3-group">
        ...
        <div id="sm-assignments" class="w3-submenu" role="group" aria-label="Assignments submenu">
          <a href="/instructor/assignments/manage" class="w3-link">My Assignments</a>
          <a href="/instructor/assignments/create" class="w3-link">Create Assignment</a>
        </div>
      </div>
    ...
    <nav class="w3-menu d-lg-none" aria-label="Account">
      <a href="/instructor/profile" class="w3-link"><i class="fa fa-id-badge"></i><span>Profile</span></a>
      <a href="/instructor/settings" class="w3-link"><i class="fa fa-gear"></i><span>Settings</span></a>
    </nav>
  </div>
...
<header class="w3-appbar">
  <div class="w3-appbar-inner">
    ...
    <!-- Mobile brand -->
    <a href="/instructor/dashboard" class="w3-app-logo d-lg-none">
    ...
    <strong class="ms-1 d-none d-lg-inline" style="font-family:var(--font-head);color:var(--ink)">
      @yield('title','W3Techiez Instructor')
    </strong>
    ...
    <div class="ms-auto d-flex align-items-center gap-2">
      ...
      <div class="dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-end p-2 shadow" style="min-width:320px">
          <div class="d-flex align-items-center justify-content-between px-2 mb-2">
            ...
            <a class="text-muted" href="/instructor/notifications">View all</a>
          </div>
          <div class="w3-note rounded-xs">
            <div class="small"><strong>New assignment submission</strong> — 5 students submitted Assignment #3.</div>
          </div>
        </div>
      </div>
      ...
      <div class="dropdown d-none d-lg-block">
        <a href="#" class="btn btn-primary rounded-pill d-flex align-items-center gap-2 px-3" id="userMenu" data-bs-toggle="dropdown" aria-expanded="false">
          ...
          <span id="userRoleLabel" class="d-none d-xl-inline">Instructor</span>
        </a>
        <ul class="dropdown-menu dropdown-menu-end shadow">
          <li class="dropdown-header">Account</li>
          <li><a class="dropdown-item" href="/instructor/profile"><i class="fa fa-id-badge me-2"></i>Profile</a></li>
          <li><a class="dropdown-item" href="/instructor/settings"><i class="fa fa-gear me-2"></i>Settings</a></li>
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  roleLabelEl && (roleLabelEl.textContent = titleizeRole(roleFromStorage) || 'Instructor');
 
  // ===== Logout with SweetAlert2 - REDIRECTION TO HOME PAGE
