{{-- resources/views/users/admin/layout/structure.blade.php
    W3Techiez Layout (Admin) • Routes wired to:
    - route('dashboard') → /admin/dashboard
    - url('/admin/users/manage')
    - url('/admin/courses/create')
    - url('/admin/courses/manage')
    - url('/admin/batches/manage')
    - route('mailers.manage') → /admin/mailers/manage
--}}
<!DOCTYPE html>
<html lang="en">
<head>
...
<aside id="sidebar" class="w3-sidebar" aria-label="Sidebar">
  <div class="w3-sidebar-head">
    <a href="{{ route('dashboard') }}" class="w3-brand">
  ...
  <div class="w3-sidebar-scroll">
    ...
    <nav class="w3-menu" aria-label="Overview">
      <a href="{{ route('dashboard') }}" class="w3-link"><i class="fa-solid fa-gauge"></i><span>Dashboard</span></a>
    </nav>
    ...
    <nav class="w3-menu" aria-label="Academics">
      <div class="w3-group">
        ...
        <div id="sm-courses" class="w3-submenu" role="group" aria-label="Courses submenu">
          <a href="{{ url('/admin/courses/manage') }}" class="w3-link">All Courses</a>
          <a href="{{ url('/admin/courses/create') }}" class="w3-link">Create Course</a>
          <a href="{{ url('/admin/categories') }}" class="w3-link">Categories</a>
        </div>
      </div>
      ...
      <div class="w3-group">
        ...
        <div id="sm-faculty" class="w3-submenu" role="group" aria-label="Faculty submenu">
          <a href="{{ url('/admin/faculty') }}" class="w3-link">Manage Faculty</a>
          <a href="{{ url('/admin/faculty/hiring') }}" class="w3-link">Hiring</a>
        </div>
      </div>
      ...
      <div class="w3-group">
        ...
        <div id="sm-students" class="w3-submenu" role="group" aria-label="Students submenu">
          <a href="{{ url('/admin/users/manage') }}" class="w3-link">Manage Users</a>
          <a href="{{ url('/admin/batches/manage') }}" class="w3-link">Batches</a>
          <a href="{{ url('/admin/enrolments') }}" class="w3-link">Enrolments</a>
        </div>
      </div>
    </nav>
    ...
    <nav class="w3-menu" aria-label="Operations">
      <div class="w3-group">
        ...
        <div id="sm-schedule" class="w3-submenu" role="group" aria-label="Schedule submenu">
          <a href="{{ url('/admin/schedule') }}" class="w3-link">Calendar</a>
          <a href="{{ url('/admin/exams') }}" class="w3-link">Exams</a>
          <a href="{{ url('/admin/rooms') }}" class="w3-link">Rooms</a>
        </div>
      </div>
      ...
      <div class="w3-group">
        ...
        <div id="sm-fin" class="w3-submenu" role="group" aria-label="Finance submenu">
          <a href="{{ url('/admin/finance') }}" class="w3-link">Overview</a>
          <a href="{{ url('/admin/finance/invoices') }}" class="w3-link">Invoices</a>
          <a href="{{ url('/admin/finance/scholarships') }}" class="w3-link">Scholarships</a>
        </div>
      </div>

      <a href="{{ route('mailers.manage') }}" class="w3-link"><i class="fa-solid fa-gear"></i><span>Mailer</span></a>
    </nav>
    ...
    <nav class="w3-menu d-lg-none" aria-label="Account">
      <a href="{{ url('/profile') }}" class="w3-link"><i class="fa fa-id-badge"></i><span>Profile</span></a>
      <a href="{{ url('/settings') }}" class="w3-link"><i class="fa fa-gear"></i><span>Settings</span></a>
    </nav>
  </div>
...
<header class="w3-appbar">
  <div class="w3-appbar-inner">
    ...
    <!-- Mobile brand -->
    <a href="{{ route('dashboard') }}" class="w3-app-logo d-lg-none">
    ...
    <div class="ms-auto d-flex align-items-center gap-2">
      ...
      <div class="dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-end p-2 shadow" style="min-width:320px">
          <div class="d-flex align-items-center justify-content-between px-2 mb-2">
            ...
            <a class="text-muted" href="{{ url('/admin/notifications') }}">View all</a>
          </div>
      ...
      <div class="dropdown d-none d-lg-block">
        ...
        <ul class="dropdown-menu dropdown-menu-end shadow">
          ...
          <li><a class="dropdown-item" href="{{ url('/profile') }}"><i class="fa fa-id-badge me-2"></i>Profile</a></li>
